...
# BASE IMAGE
###############################################
# Use a slim Python base image suitable for running the tests
...
# SYSTEM DEPENDENCIES
###############################################
# Install git, bash and a minimal Python environment
RUN apt-get update && \
...
# REPO SETUP
###############################################
# Clone the iommi repository into /app
RUN git clone https://github.com/iommirocks/iommi.git .
